...
uint64_t amdgv_ffbm_copy_to_gpa(struct amdgv_adapter *adapt, uint32_t *data, uint32_t idx_vf, uint64_t gpa, uint64_t size);
uint64_t amdgv_ffbm_copy_from_gpa(struct amdgv_adapter *adapt, uint32_t *data, uint32_t idx_vf, uint64_t gpa, uint64_t size);
