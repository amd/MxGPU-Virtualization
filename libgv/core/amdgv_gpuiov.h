...
struct amdgv_gpuiov_funcs {
	...
	int (*transfer_vf_data)(struct amdgv_adapter *adapt, uint32_t hw_sched_id, uint32_t idx_vf, bool to_export);
...
int amdgv_gpuiov_get_version(struct amdgv_adapter *adapt, uint32_t *ip_version);
#endif
