...
#if defined(DEBUG_WS_STATE_MACHINE) || defined(DEBUG_WS_STATE_MACHINE_MANUAL)
#define DEBUG_WS_STATE_MACHINE_MANUAL_LOG 1
#else
#define DEBUG_WS_STATE_MACHINE_MANUAL_LOG 0
#endif

#if (defined(DEBUG_WS_STATE_MACHINE) || defined(DEBUG_WS_STATE_MACHINE_AUTO))
#define DEBUG_WS_STATE_MACHINE_AUTO_LOG 1
#else
#define DEBUG_WS_STATE_MACHINE_AUTO_LOG 0
#endif
