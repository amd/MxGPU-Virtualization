...
#ifndef MI200_SMU13_DRIVER_IF_H
#define MI200_SMU13_DRIVER_IF_H
...
#define MI200_UMC_CHANNEL_NUM    32
...
typedef struct {
  ...
  uint8_t  StartupSmnclkDid;     //CLK31_CLK3_CLK0_DFS_CNTL
  uint8_t  StartupMp0clkDid;     //CLK0_CLK2_DFS_CNTL
  uint8_t  StartupMp1clkDid;     //CLK31_CLK3_CLK1_DFS_CNTL
  uint8_t  StartupWaflclkDid;    //CLK30_CLK3_CLK2_DFS_CNTL
  uint8_t  StartupGfxavfsclkDid; //CLK0_CLK0_DFS_CNTL
  uint8_t  StartupMpioclkDid;    //CLK0_CLK3_DFS_CNTL
  uint8_t  StartupDxioclkDid;    //CLK0_CLK4_DFS_CNTL
  uint8_t  spare123;
...
typedef struct {
  EccInfo_t  EccInfo[MI200_UMC_CHANNEL_NUM];
} EccInfoTable_t;
