...
# values for enumeration 'c__EA_amdsmi_processor_type_t'
c__EA_amdsmi_processor_type_t__enumvalues = {
...
c__EA_amdsmi_processor_type_t = ctypes.c_uint32 # enum
amdsmi_processor_type_t = c__EA_amdsmi_processor_type_t
amdsmi_processor_type_t__enumvalues = c__EA_amdsmi_processor_type_t__enumvalues
processor_type_t = c__EA_amdsmi_processor_type_t
processor_type_t__enumvalues = c__EA_amdsmi_processor_type_t__enumvalues
...
# values for enumeration 'c__EA_amdsmi_virtualization_mode_t'
c__EA_amdsmi_virtualization_mode_t__enumvalues = {
...
# values for enumeration 'c__EA_amdsmi_npm_status_t'
c__EA_amdsmi_npm_status_t__enumvalues = {
...
union_c__UA_amdsmi_bdf_t._fields_ = [
    ('bdf', struct_bdf_),
    ('c__UA_amdsmi_bdf_t_1', struct_c__UA_amdsmi_bdf_t_1),
...
# values for enumeration 'c__EA_amdsmi_power_cap_type_t'
c__EA_amdsmi_power_cap_type_t__enumvalues = {
    0: 'AMDSMI_POWER_CAP_TYPE_PPT0',
    1: 'AMDSMI_POWER_CAP_TYPE_PPT1',
}
AMDSMI_POWER_CAP_TYPE_PPT0 = 0
AMDSMI_POWER_CAP_TYPE_PPT1 = 1
c__EA_amdsmi_power_cap_type_t = ctypes.c_uint32 # enum
amdsmi_power_cap_type_t = c__EA_amdsmi_power_cap_type_t
amdsmi_power_cap_type_t__enumvalues = c__EA_amdsmi_power_cap_type_t__enumvalues
...
class struct_c__SA_amdsmi_npm_info_t(Structure):
    pass

struct_c__SA_amdsmi_npm_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_npm_info_t._fields_ = [
...
# values for enumeration 'c__EA_amdsmi_cper_notify_type_t'
c__EA_amdsmi_cper_notify_type_t__enumvalues = {
...
c__EA_amdsmi_cper_notify_type_t = ctypes.c_uint64 # enum
amdsmi_cper_notify_type_t = c__EA_amdsmi_cper_notify_type_t
amdsmi_cper_notify_type_t__enumvalues = c__EA_amdsmi_cper_notify_type_t__enumvalues
class struct_c__SA_amdsmi_gpu_ras_policy_v4_0_t(Structure):
    pass

struct_c__SA_amdsmi_gpu_ras_policy_v4_0_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_gpu_ras_policy_v4_0_t._fields_ = [
...
struct_c__SA_amdsmi_gpu_ras_policy_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_gpu_ras_policy_info_t._fields_ = [
...
amdsmi_gpu_ras_policy_info_t = struct_c__SA_amdsmi_gpu_ras_policy_info_t
...
class union_c__UA_amdsmi_cper_valid_bits_t(Union):
    pass
...
union_c__UA_amdsmi_cper_valid_bits_t._pack_ = 1 # source:False
union_c__UA_amdsmi_cper_valid_bits_t._fields_ = [
    ('valid_bits', struct_valid_bits_),
    ('valid_mask', ctypes.c_uint32),
]

amdsmi_cper_valid_bits_t = union_c__UA_amdsmi_cper_valid_bits_t
...
c__EA_amdsmi_event_driver_t__enumvalues = {
    ...
    32: 'AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_INIT_FAIL',
    33: 'AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_MEM_REQ_FAIL',
    34: 'AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_VADDR_REQ_FAIL',
    35: 'AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_BUS_ADDR_REQ_FAIL',
    36: 'AMDSMI_EVENT_DRIVER_HRTIMER_START_FAIL',
    37: 'AMDSMI_EVENT_DRIVER_CREATE_DRIVER_FILE_FAIL',
    38: 'AMDSMI_EVENT_DRIVER_CREATE_DEVICE_FILE_FAIL',
    39: 'AMDSMI_EVENT_DRIVER_CREATE_DEBUGFS_FILE_FAIL',
    40: 'AMDSMI_EVENT_DRIVER_CREATE_DEBUGFS_DIR_FAIL',
    41: 'AMDSMI_EVENT_DRIVER_PCI_ENABLE_DEVICE_FAIL',
    42: 'AMDSMI_EVENT_DRIVER_FB_MAP_FAIL',
    43: 'AMDSMI_EVENT_DRIVER_DOORBELL_MAP_FAIL',
    44: 'AMDSMI_EVENT_DRIVER_PCI_REGISTER_DRIVER_FAIL',
    45: 'AMDSMI_EVENT_DRIVER_ALLOC_IOVA_ALIGN_FAIL',
    46: 'AMDSMI_EVENT_DRIVER_ROM_MAP_FAIL',
    47: 'AMDSMI_EVENT_DRIVER_FULL_ACCESS_TIMEOUT',
    48: 'AMDSMI_EVENT_DRIVER__MAX',
}
...
AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_INIT_FAIL = 32
AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_MEM_REQ_FAIL = 33
AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_VADDR_REQ_FAIL = 34
AMDSMI_EVENT_DRIVER_REMOTE_DEBUG_BUS_ADDR_REQ_FAIL = 35
AMDSMI_EVENT_DRIVER_HRTIMER_START_FAIL = 36
AMDSMI_EVENT_DRIVER_CREATE_DRIVER_FILE_FAIL = 37
AMDSMI_EVENT_DRIVER_CREATE_DEVICE_FILE_FAIL = 38
AMDSMI_EVENT_DRIVER_CREATE_DEBUGFS_FILE_FAIL = 39
AMDSMI_EVENT_DRIVER_CREATE_DEBUGFS_DIR_FAIL = 40
AMDSMI_EVENT_DRIVER_PCI_ENABLE_DEVICE_FAIL = 41
AMDSMI_EVENT_DRIVER_FB_MAP_FAIL = 42
AMDSMI_EVENT_DRIVER_DOORBELL_MAP_FAIL = 43
AMDSMI_EVENT_DRIVER_PCI_REGISTER_DRIVER_FAIL = 44
AMDSMI_EVENT_DRIVER_ALLOC_IOVA_ALIGN_FAIL = 45
AMDSMI_EVENT_DRIVER_ROM_MAP_FAIL = 46
AMDSMI_EVENT_DRIVER_FULL_ACCESS_TIMEOUT = 47
AMDSMI_EVENT_DRIVER__MAX = 48
...
c__EA_amdsmi_guest_fw_load_status_t__enumvalues = {
    0: 'AMDSMI_GUEST_FW_LOAD_STATUS_OK',
    1: 'AMDSMI_GUEST_FW_LOAD_STATUS_OBSOLETE_FW',
    2: 'AMDSMI_GUEST_FW_LOAD_STATUS_BAD_SIG',
    3: 'AMDSMI_GUEST_FW_LOAD_STATUS_FW_LOAD_FAIL',
    4: 'AMDSMI_GUEST_FW_LOAD_STATUS_ERR_GENERIC',
}
...
c__EA_amdsmi_metric_category_t__enumvalues = {
    ...
    8: 'AMDSMI_METRIC_CATEGORY_STATIC',
    9: 'AMDSMI_METRIC_CATEGORY_SYS_ACC_COUNTER',
    10: 'AMDSMI_METRIC_CATEGORY_SYS_BASEBOARD_TEMP',
    11: 'AMDSMI_METRIC_CATEGORY_SYS_GPUBOARD_TEMP',
    12: 'AMDSMI_METRIC_CATEGORY_SYS_BASEBOARD_POWER',
    13: 'AMDSMI_METRIC_CATEGORY_STATIC_FREQUENCY',
    14: 'AMDSMI_METRIC_CATEGORY_STATIC_TEMPERATURE',
    15: 'AMDSMI_METRIC_CATEGORY_STATIC_THROTTLE',
    16: 'AMDSMI_METRIC_CATEGORY_UNKNOWN',
}
...
AMDSMI_METRIC_CATEGORY_STATIC = 8
AMDSMI_METRIC_CATEGORY_SYS_ACC_COUNTER = 9
AMDSMI_METRIC_CATEGORY_SYS_BASEBOARD_TEMP = 10
AMDSMI_METRIC_CATEGORY_SYS_GPUBOARD_TEMP = 11
AMDSMI_METRIC_CATEGORY_SYS_BASEBOARD_POWER = 12
AMDSMI_METRIC_CATEGORY_STATIC_FREQUENCY = 13
AMDSMI_METRIC_CATEGORY_STATIC_TEMPERATURE = 14
AMDSMI_METRIC_CATEGORY_STATIC_THROTTLE = 15
AMDSMI_METRIC_CATEGORY_UNKNOWN = 16
...
c__EA_amdsmi_metric_name_t__enumvalues = {
    ...
    31: 'AMDSMI_METRIC_NAME_THROTTLE_PROCHOT_ACTIVE',
    32: 'AMDSMI_METRIC_NAME_THROTTLE_PPT_ACTIVE',
    33: 'AMDSMI_METRIC_NAME_PCIE_BANDWIDTH',
    34: 'AMDSMI_METRIC_NAME_PCIE_L0_TO_RECOVERY_COUNT',
    35: 'AMDSMI_METRIC_NAME_PCIE_REPLAY_COUNT',
    36: 'AMDSMI_METRIC_NAME_PCIE_REPLAY_ROLLOVER_COUNT',
    37: 'AMDSMI_METRIC_NAME_PCIE_NAK_SENT_COUNT',
    38: 'AMDSMI_METRIC_NAME_PCIE_NAK_RECEIVED_COUNT',
    39: 'AMDSMI_METRIC_NAME_CLK_GFX_MAX_LIMIT',
    40: 'AMDSMI_METRIC_NAME_CLK_SOC_MAX_LIMIT',
    41: 'AMDSMI_METRIC_NAME_CLK_MEM_MAX_LIMIT',
    42: 'AMDSMI_METRIC_NAME_CLK_VCLK_MAX_LIMIT',
    43: 'AMDSMI_METRIC_NAME_CLK_DCLK_MAX_LIMIT',
    44: 'AMDSMI_METRIC_NAME_CLK_GFX_MIN_LIMIT',
    45: 'AMDSMI_METRIC_NAME_CLK_SOC_MIN_LIMIT',
    46: 'AMDSMI_METRIC_NAME_CLK_MEM_MIN_LIMIT',
    47: 'AMDSMI_METRIC_NAME_CLK_VCLK_MIN_LIMIT',
    48: 'AMDSMI_METRIC_NAME_CLK_DCLK_MIN_LIMIT',
    49: 'AMDSMI_METRIC_NAME_CLK_GFX_LOCKED',
    50: 'AMDSMI_METRIC_NAME_CLK_GFX_DS_DISABLED',
    51: 'AMDSMI_METRIC_NAME_CLK_MEM_DS_DISABLED',
    52: 'AMDSMI_METRIC_NAME_CLK_SOC_DS_DISABLED',
    53: 'AMDSMI_METRIC_NAME_CLK_VCLK_DS_DISABLED',
    54: 'AMDSMI_METRIC_NAME_CLK_DCLK_DS_DISABLED',
    55: 'AMDSMI_METRIC_NAME_PCIE_LINK_SPEED',
    56: 'AMDSMI_METRIC_NAME_PCIE_LINK_WIDTH',
    57: 'AMDSMI_METRIC_NAME_DRAM_BANDWIDTH',
    58: 'AMDSMI_METRIC_NAME_MAX_DRAM_BANDWIDTH',
    59: 'AMDSMI_METRIC_NAME_GFX_CLK_BELOW_HOST_LIMIT_PPT',
    60: 'AMDSMI_METRIC_NAME_GFX_CLK_BELOW_HOST_LIMIT_THM',
    61: 'AMDSMI_METRIC_NAME_GFX_CLK_BELOW_HOST_LIMIT_TOTAL',
    62: 'AMDSMI_METRIC_NAME_GFX_CLK_LOW_UTILIZATION',
    63: 'AMDSMI_METRIC_NAME_INPUT_TELEMETRY_VOLTAGE',
    64: 'AMDSMI_METRIC_NAME_PLDM_VERSION',
    65: 'AMDSMI_METRIC_NAME_TEMP_XCD',
    66: 'AMDSMI_METRIC_NAME_TEMP_AID',
    67: 'AMDSMI_METRIC_NAME_TEMP_HBM',
    68: 'AMDSMI_METRIC_NAME_SYS_METRIC_ACC_COUNTER',
    69: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FPGA',
    70: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FRONT',
    71: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_BACK',
    72: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_OAM7',
    73: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_IBC',
    74: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_UFPGA',
    75: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_OAM1',
    76: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_0_1_HSC',
    77: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_2_3_HSC',
    78: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_4_5_HSC',
    79: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_6_7_HSC',
    80: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FPGA_0V72_VR',
    81: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FPGA_3V3_VR',
    82: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_0_1_2_3_1V2_VR',
    83: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_4_5_6_7_1V2_VR',
    84: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_0_1_0V9_VR',
    85: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_4_5_0V9_VR',
    86: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_2_3_0V9_VR',
    87: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_6_7_0V9_VR',
    88: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_0_1_2_3_3V3_VR',
    89: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_4_5_6_7_3V3_VR',
    90: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_IBC_HSC',
    91: 'AMDSMI_METRIC_NAME_SYSTEM_TEMP_IBC',
    92: 'AMDSMI_METRIC_NAME_NODE_TEMP_RETIMER',
    93: 'AMDSMI_METRIC_NAME_NODE_TEMP_IBC_TEMP',
    94: 'AMDSMI_METRIC_NAME_NODE_TEMP_IBC_2_TEMP',
    95: 'AMDSMI_METRIC_NAME_NODE_TEMP_VDD18_VR_TEMP',
    96: 'AMDSMI_METRIC_NAME_NODE_TEMP_04_HBM_B_VR_TEMP',
    97: 'AMDSMI_METRIC_NAME_NODE_TEMP_04_HBM_D_VR_TEMP',
    98: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD0',
    99: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD1',
    100: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD2',
    101: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD3',
    102: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOC_A',
    103: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOC_C',
    104: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOCIO_A',
    105: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOCIO_C',
    106: 'AMDSMI_METRIC_NAME_VR_TEMP_VDD_085_HBM',
    107: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_11_HBM_B',
    108: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_11_HBM_D',
    109: 'AMDSMI_METRIC_NAME_VR_TEMP_VDD_USR',
    110: 'AMDSMI_METRIC_NAME_VR_TEMP_VDDIO_11_E32',
    111: 'AMDSMI_METRIC_NAME_TEMP_MID',
    112: 'AMDSMI_METRIC_NAME_CLK_FCLK',
    113: 'AMDSMI_METRIC_NAME_CLK_FCLK_MAX_LIMIT',
    114: 'AMDSMI_METRIC_NAME_CLK_FCLK_MIN_LIMIT',
    115: 'AMDSMI_METRIC_NAME_CLK_FCLK_DS_DISABLED',
    116: 'AMDSMI_METRIC_NAME_CLK_LCLK',
    117: 'AMDSMI_METRIC_NAME_CLK_LCLK_MAX_LIMIT',
    118: 'AMDSMI_METRIC_NAME_CLK_LCLK_MIN_LIMIT',
    119: 'AMDSMI_METRIC_NAME_CLK_LCLK_DS_DISABLED',
    120: 'AMDSMI_METRIC_NAME_PCIE_OTHER_END_RECOVERY_COUNT',
    121: 'AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_XCD',
    122: 'AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_AID',
    123: 'AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_MID',
    124: 'AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_HBM',
    125: 'AMDSMI_METRIC_NAME_TEMP_THROTTLE_XCD',
    126: 'AMDSMI_METRIC_NAME_TEMP_THROTTLE_AID',
    127: 'AMDSMI_METRIC_NAME_TEMP_THROTTLE_MID',
    128: 'AMDSMI_METRIC_NAME_TEMP_THROTTLE_HBM',
    129: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_X0_TEMP',
    130: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_X1_TEMP',
    131: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_HBM_B_TEMP',
    132: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_HBM_D_TEMP',
    133: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_04_HBM_B_TEMP',
    134: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_04_HBM_D_TEMP',
    135: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_HBM_B_TEMP',
    136: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_HBM_D_TEMP',
    137: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_075_HBM_B_TEMP',
    138: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_075_HBM_D_TEMP',
    139: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_11_GTA_A_TEMP',
    140: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_11_GTA_C_TEMP',
    141: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDAN_075_GTA_A_TEMP',
    142: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDAN_075_GTA_C_TEMP',
    143: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_075_UCIE_TEMP',
    144: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_065_UCIEAA_TEMP',
    145: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_065_UCIEAM_A_TEMP',
    146: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_065_UCIEAM_C_TEMP',
    147: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_SOCIO_A_TEMP',
    148: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_SOCIO_C_TEMP',
    149: 'AMDSMI_METRIC_NAME_SVI_PLANE_VDDAN_075_TEMP',
    150: 'AMDSMI_METRIC_NAME_SYSTEM_POWER_UBB_POWER',
    151: 'AMDSMI_METRIC_NAME_SYSTEM_POWER_UBB_POWER_THRESHOLD',
    152: 'AMDSMI_METRIC_NAME_UNKNOWN',
}
...
AMDSMI_METRIC_NAME_THROTTLE_PROCHOT_ACTIVE = 31
AMDSMI_METRIC_NAME_THROTTLE_PPT_ACTIVE = 32
AMDSMI_METRIC_NAME_PCIE_BANDWIDTH = 33
AMDSMI_METRIC_NAME_PCIE_L0_TO_RECOVERY_COUNT = 34
AMDSMI_METRIC_NAME_PCIE_REPLAY_COUNT = 35
AMDSMI_METRIC_NAME_PCIE_REPLAY_ROLLOVER_COUNT = 36
AMDSMI_METRIC_NAME_PCIE_NAK_SENT_COUNT = 37
AMDSMI_METRIC_NAME_PCIE_NAK_RECEIVED_COUNT = 38
AMDSMI_METRIC_NAME_CLK_GFX_MAX_LIMIT = 39
AMDSMI_METRIC_NAME_CLK_SOC_MAX_LIMIT = 40
AMDSMI_METRIC_NAME_CLK_MEM_MAX_LIMIT = 41
AMDSMI_METRIC_NAME_CLK_VCLK_MAX_LIMIT = 42
AMDSMI_METRIC_NAME_CLK_DCLK_MAX_LIMIT = 43
AMDSMI_METRIC_NAME_CLK_GFX_MIN_LIMIT = 44
AMDSMI_METRIC_NAME_CLK_SOC_MIN_LIMIT = 45
AMDSMI_METRIC_NAME_CLK_MEM_MIN_LIMIT = 46
AMDSMI_METRIC_NAME_CLK_VCLK_MIN_LIMIT = 47
AMDSMI_METRIC_NAME_CLK_DCLK_MIN_LIMIT = 48
AMDSMI_METRIC_NAME_CLK_GFX_LOCKED = 49
AMDSMI_METRIC_NAME_CLK_GFX_DS_DISABLED = 50
AMDSMI_METRIC_NAME_CLK_MEM_DS_DISABLED = 51
AMDSMI_METRIC_NAME_CLK_SOC_DS_DISABLED = 52
AMDSMI_METRIC_NAME_CLK_VCLK_DS_DISABLED = 53
AMDSMI_METRIC_NAME_CLK_DCLK_DS_DISABLED = 54
AMDSMI_METRIC_NAME_PCIE_LINK_SPEED = 55
AMDSMI_METRIC_NAME_PCIE_LINK_WIDTH = 56
AMDSMI_METRIC_NAME_DRAM_BANDWIDTH = 57
AMDSMI_METRIC_NAME_MAX_DRAM_BANDWIDTH = 58
AMDSMI_METRIC_NAME_GFX_CLK_BELOW_HOST_LIMIT_PPT = 59
AMDSMI_METRIC_NAME_GFX_CLK_BELOW_HOST_LIMIT_THM = 60
AMDSMI_METRIC_NAME_GFX_CLK_BELOW_HOST_LIMIT_TOTAL = 61
AMDSMI_METRIC_NAME_GFX_CLK_LOW_UTILIZATION = 62
AMDSMI_METRIC_NAME_INPUT_TELEMETRY_VOLTAGE = 63
AMDSMI_METRIC_NAME_PLDM_VERSION = 64
AMDSMI_METRIC_NAME_TEMP_XCD = 65
AMDSMI_METRIC_NAME_TEMP_AID = 66
AMDSMI_METRIC_NAME_TEMP_HBM = 67
AMDSMI_METRIC_NAME_SYS_METRIC_ACC_COUNTER = 68
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FPGA = 69
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FRONT = 70
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_BACK = 71
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_OAM7 = 72
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_IBC = 73
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_UFPGA = 74
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_OAM1 = 75
AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_0_1_HSC = 76
AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_2_3_HSC = 77
AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_4_5_HSC = 78
AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_6_7_HSC = 79
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FPGA_0V72_VR = 80
AMDSMI_METRIC_NAME_SYSTEM_TEMP_UBB_FPGA_3V3_VR = 81
AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_0_1_2_3_1V2_VR = 82
AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_4_5_6_7_1V2_VR = 83
AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_0_1_0V9_VR = 84
AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_4_5_0V9_VR = 85
AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_2_3_0V9_VR = 86
AMDSMI_METRIC_NAME_SYSTEM_TEMP_RETIMER_6_7_0V9_VR = 87
AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_0_1_2_3_3V3_VR = 88
AMDSMI_METRIC_NAME_SYSTEM_TEMP_OAM_4_5_6_7_3V3_VR = 89
AMDSMI_METRIC_NAME_SYSTEM_TEMP_IBC_HSC = 90
AMDSMI_METRIC_NAME_SYSTEM_TEMP_IBC = 91
AMDSMI_METRIC_NAME_NODE_TEMP_RETIMER = 92
AMDSMI_METRIC_NAME_NODE_TEMP_IBC_TEMP = 93
AMDSMI_METRIC_NAME_NODE_TEMP_IBC_2_TEMP = 94
AMDSMI_METRIC_NAME_NODE_TEMP_VDD18_VR_TEMP = 95
AMDSMI_METRIC_NAME_NODE_TEMP_04_HBM_B_VR_TEMP = 96
AMDSMI_METRIC_NAME_NODE_TEMP_04_HBM_D_VR_TEMP = 97
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD0 = 98
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD1 = 99
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD2 = 100
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_VDD3 = 101
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOC_A = 102
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOC_C = 103
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOCIO_A = 104
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_SOCIO_C = 105
AMDSMI_METRIC_NAME_VR_TEMP_VDD_085_HBM = 106
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_11_HBM_B = 107
AMDSMI_METRIC_NAME_VR_TEMP_VDDCR_11_HBM_D = 108
AMDSMI_METRIC_NAME_VR_TEMP_VDD_USR = 109
AMDSMI_METRIC_NAME_VR_TEMP_VDDIO_11_E32 = 110
AMDSMI_METRIC_NAME_TEMP_MID = 111
AMDSMI_METRIC_NAME_CLK_FCLK = 112
AMDSMI_METRIC_NAME_CLK_FCLK_MAX_LIMIT = 113
AMDSMI_METRIC_NAME_CLK_FCLK_MIN_LIMIT = 114
AMDSMI_METRIC_NAME_CLK_FCLK_DS_DISABLED = 115
AMDSMI_METRIC_NAME_CLK_LCLK = 116
AMDSMI_METRIC_NAME_CLK_LCLK_MAX_LIMIT = 117
AMDSMI_METRIC_NAME_CLK_LCLK_MIN_LIMIT = 118
AMDSMI_METRIC_NAME_CLK_LCLK_DS_DISABLED = 119
AMDSMI_METRIC_NAME_PCIE_OTHER_END_RECOVERY_COUNT = 120
AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_XCD = 121
AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_AID = 122
AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_MID = 123
AMDSMI_METRIC_NAME_TEMP_SHUTDOWN_HBM = 124
AMDSMI_METRIC_NAME_TEMP_THROTTLE_XCD = 125
AMDSMI_METRIC_NAME_TEMP_THROTTLE_AID = 126
AMDSMI_METRIC_NAME_TEMP_THROTTLE_MID = 127
AMDSMI_METRIC_NAME_TEMP_THROTTLE_HBM = 128
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_X0_TEMP = 129
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_X1_TEMP = 130
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_HBM_B_TEMP = 131
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_HBM_D_TEMP = 132
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_04_HBM_B_TEMP = 133
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_04_HBM_D_TEMP = 134
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_HBM_B_TEMP = 135
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_HBM_D_TEMP = 136
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_075_HBM_B_TEMP = 137
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_075_HBM_D_TEMP = 138
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_11_GTA_A_TEMP = 139
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_11_GTA_C_TEMP = 140
AMDSMI_METRIC_NAME_SVI_PLANE_VDDAN_075_GTA_A_TEMP = 141
AMDSMI_METRIC_NAME_SVI_PLANE_VDDAN_075_GTA_C_TEMP = 142
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_075_UCIE_TEMP = 143
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_065_UCIEAA_TEMP = 144
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_065_UCIEAM_A_TEMP = 145
AMDSMI_METRIC_NAME_SVI_PLANE_VDDIO_065_UCIEAM_C_TEMP = 146
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_SOCIO_A_TEMP = 147
AMDSMI_METRIC_NAME_SVI_PLANE_VDDCR_SOCIO_C_TEMP = 148
AMDSMI_METRIC_NAME_SVI_PLANE_VDDAN_075_TEMP = 149
AMDSMI_METRIC_NAME_SYSTEM_POWER_UBB_POWER = 150
AMDSMI_METRIC_NAME_SYSTEM_POWER_UBB_POWER_THRESHOLD = 151
AMDSMI_METRIC_NAME_UNKNOWN = 152
...
c__EA_amdsmi_metric_unit_t__enumvalues = {
    ...
    13: 'AMDSMI_METRIC_UNIT_15_625_MILLIJOULE',
    14: 'AMDSMI_METRIC_UNIT_UNKNOWN',
}
...
AMDSMI_METRIC_UNIT_15_625_MILLIJOULE = 13
AMDSMI_METRIC_UNIT_UNKNOWN = 14
...
c__EA_amdsmi_metric_res_group_t__enumvalues = {
    ...
    6: 'AMDSMI_METRIC_RES_GROUP_SYSTEM',
}
...
AMDSMI_METRIC_RES_GROUP_SYSTEM = 6
...
c__EA_amdsmi_metric_res_subgroup_t__enumvalues = {
    ...
    4: 'AMDSMI_METRIC_RES_SUBGROUP_HBM',
    5: 'AMDSMI_METRIC_RES_SUBGROUP_BASEBOARD',
    6: 'AMDSMI_METRIC_RES_SUBGROUP_GPUBOARD',
}
...
AMDSMI_METRIC_RES_SUBGROUP_HBM = 4
AMDSMI_METRIC_RES_SUBGROUP_BASEBOARD = 5
AMDSMI_METRIC_RES_SUBGROUP_GPUBOARD = 6
...
# values for enumeration 'c__EA_amdsmi_vf_mode_t'
c__EA_amdsmi_vf_mode_t__enumvalues = {
    2: 'AMDSMI_VF_MODE_1',
    4: 'AMDSMI_VF_MODE_2',
    16: 'AMDSMI_VF_MODE_4',
    256: 'AMDSMI_VF_MODE_8',
    278: 'AMDSMI_VF_MODE_ALL',
}
AMDSMI_VF_MODE_1 = 2
AMDSMI_VF_MODE_2 = 4
AMDSMI_VF_MODE_4 = 16
AMDSMI_VF_MODE_8 = 256
AMDSMI_VF_MODE_ALL = 278
c__EA_amdsmi_vf_mode_t = ctypes.c_uint32 # enum
...
c__EA_amdsmi_tdi_state_t__enumvalues = {
    ...
    1: 'AMDSMI_TDI_STATE_LOCKED',
    2: 'AMDSMI_TDI_STATE_RUN',
    3: 'AMDSMI_TDI_STATE_ERROR',
}
AMDSMI_TDI_STATE_UNLOCKED = 0
AMDSMI_TDI_STATE_LOCKED = 1
AMDSMI_TDI_STATE_RUN = 2
AMDSMI_TDI_STATE_ERROR = 3
c__EA_amdsmi_tdi_state_t = ctypes.c_uint32 # enum
amdsmi_tdi_state_t = c__EA_amdsmi_tdi_state_t
amdsmi_tdi_state_t__enumvalues = c__EA_amdsmi_tdi_state_t__enumvalues

# values for enumeration 'c__EA_amdsmi_cc_mode_t'
c__EA_amdsmi_cc_mode_t__enumvalues = {
    0: 'AMDSMI_CC_MODE_OFF',
    1: 'AMDSMI_CC_MODE_ON',
    2: 'AMDSMI_CC_MODE_DEV',
}
AMDSMI_CC_MODE_OFF = 0
AMDSMI_CC_MODE_ON = 1
AMDSMI_CC_MODE_DEV = 2
c__EA_amdsmi_cc_mode_t = ctypes.c_uint32 # enum
amdsmi_cc_mode_t = c__EA_amdsmi_cc_mode_t
amdsmi_cc_mode_t__enumvalues = c__EA_amdsmi_cc_mode_t__enumvalues
...
class struct_c__SA_amdsmi_handshake_t(Structure):
    pass

struct_c__SA_amdsmi_handshake_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_handshake_t._fields_ = [
    ('version', ctypes.c_uint32),
]

amdsmi_handshake_t = struct_c__SA_amdsmi_handshake_t
...
class struct_c__SA_amdsmi_vf_hbm_info_t(Structure):
    pass

struct_c__SA_amdsmi_vf_hbm_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_vf_hbm_info_t._fields_ = [
    ('phy_addr', ctypes.c_uint64),
    ('phy_size', ctypes.c_uint64),
    ('numa_id', ctypes.c_uint32),
    ('name', ctypes.c_char * 256),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('reserved', ctypes.c_uint64 * 29),
]

amdsmi_vf_hbm_info_t = struct_c__SA_amdsmi_vf_hbm_info_t
...
struct_c__SA_amdsmi_sched_info_t._fields_ = [
    ...
    ('last_boot_start', ctypes.c_char * 256),
    ('last_boot_end', ctypes.c_char * 256),
    ('last_shutdown_start', ctypes.c_char * 256),
    ('last_shutdown_end', ctypes.c_char * 256),
    ('last_reset_start', ctypes.c_char * 256),
    ('last_reset_end', ctypes.c_char * 256),
    ('current_active_time', ctypes.c_char * 256),
    ('current_running_time', ctypes.c_char * 256),
    ('total_active_time', ctypes.c_char * 256),
    ('total_running_time', ctypes.c_char * 256),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('reserved', ctypes.c_uint64 * 11),
]
...
class struct_c__SA_amdsmi_accelerator_partition_profile_global_t(Structure):
    pass

struct_c__SA_amdsmi_accelerator_partition_profile_global_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_accelerator_partition_profile_global_t._fields_ = [
    ('profile', amdsmi_accelerator_partition_profile_t),
    ('vf_mode', ctypes.c_uint32),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('reserved', ctypes.c_uint64 * 6),
]

amdsmi_accelerator_partition_profile_global_t = struct_c__SA_amdsmi_accelerator_partition_profile_global_t
class struct_c__SA_amdsmi_accelerator_partition_profile_config_global_t(Structure):
    pass

struct_c__SA_amdsmi_accelerator_partition_profile_config_global_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_accelerator_partition_profile_config_global_t._fields_ = [
    ('num_profiles', ctypes.c_uint32),
    ('num_resource_profiles', ctypes.c_uint32),
    ('resource_profiles', struct_c__SA_amdsmi_accelerator_partition_resource_profile_t * 32),
    ('default_profile_index', ctypes.c_uint32),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('profiles', struct_c__SA_amdsmi_accelerator_partition_profile_global_t * 32),
    ('reserved', ctypes.c_uint64 * 30),
]
...
c__EA_amdsmi_nic_fw_version_type_t__enumvalues = {
    ...
    1: 'AMDSMI_NIC_FW_VERSION_TYPE_RUNNING',
    2: 'AMDSMI_NIC_FW_VERSION_TYPE_STORED',
}
AMDSMI_NIC_FW_VERSION_TYPE_FIXED = 0
AMDSMI_NIC_FW_VERSION_TYPE_RUNNING = 1
AMDSMI_NIC_FW_VERSION_TYPE_STORED = 2
c__EA_amdsmi_nic_fw_version_type_t = ctypes.c_uint32 # enum
amdsmi_nic_fw_version_type_t = c__EA_amdsmi_nic_fw_version_type_t
amdsmi_nic_fw_version_type_t__enumvalues = c__EA_amdsmi_nic_fw_version_type_t__enumvalues
class struct_c__SA_amdsmi_nic_stat_t(Structure):
    pass

struct_c__SA_amdsmi_nic_stat_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_stat_t._fields_ = [
    ('name', ctypes.c_char * 256),
    ('value', ctypes.c_uint64),
]

amdsmi_nic_stat_t = struct_c__SA_amdsmi_nic_stat_t
class struct_c__SA_amdsmi_nic_asic_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_asic_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_asic_info_t._fields_ = [
...
amdsmi_nic_asic_info_t = struct_c__SA_amdsmi_nic_asic_info_t
class struct_c__SA_amdsmi_nic_bus_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_bus_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_bus_info_t._fields_ = [
    ('bdf', amdsmi_bdf_t),
...
amdsmi_nic_bus_info_t = struct_c__SA_amdsmi_nic_bus_info_t
class struct_c__SA_amdsmi_nic_numa_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_numa_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_numa_info_t._fields_ = [
    ('node', ctypes.c_ubyte),
    ('affinity', ctypes.c_char * 256),
]

amdsmi_nic_numa_info_t = struct_c__SA_amdsmi_nic_numa_info_t
class struct_c__SA_amdsmi_nic_fw_t(Structure):
    pass

struct_c__SA_amdsmi_nic_fw_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_fw_t._fields_ = [
    ('name', ctypes.c_char * 256),
    ('version', ctypes.c_char * 256),
]

amdsmi_nic_fw_t = struct_c__SA_amdsmi_nic_fw_t
class struct_c__SA_amdsmi_nic_fw_entry_t(Structure):
    _pack_ = 1 # source:False
    _fields_ = [
    ('type', amdsmi_nic_fw_version_type_t),
    ('fw', amdsmi_nic_fw_t),
     ]

amdsmi_nic_fw_entry_t = struct_c__SA_amdsmi_nic_fw_entry_t
class struct_c__SA_amdsmi_nic_fw_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_fw_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_fw_info_t._fields_ = [
    ('num_fw', ctypes.c_uint32),
    ('fw', struct_c__SA_amdsmi_nic_fw_entry_t * 64),
]

amdsmi_nic_fw_info_t = struct_c__SA_amdsmi_nic_fw_info_t
class struct_c__SA_amdsmi_nic_port_t(Structure):
    pass

struct_c__SA_amdsmi_nic_port_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_port_t._fields_ = [
    ('bdf', amdsmi_bdf_t),
...
amdsmi_nic_port_t = struct_c__SA_amdsmi_nic_port_t
class struct_c__SA_amdsmi_nic_port_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_port_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_port_info_t._fields_ = [
    ('num_ports', ctypes.c_uint32),
    ('PADDING_0', ctypes.c_ubyte * 4),
    ('ports', struct_c__SA_amdsmi_nic_port_t * 32),
]

amdsmi_nic_port_info_t = struct_c__SA_amdsmi_nic_port_info_t
class struct_c__SA_amdsmi_nic_driver_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_driver_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_driver_info_t._fields_ = [
    ('name', ctypes.c_char * 256),
    ('version', ctypes.c_char * 256),
]

amdsmi_nic_driver_info_t = struct_c__SA_amdsmi_nic_driver_info_t
class struct_c__SA_amdsmi_nic_rdma_port_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_rdma_port_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_rdma_port_info_t._fields_ = [
    ('netdev', ctypes.c_char * 256),
...
amdsmi_nic_rdma_port_info_t = struct_c__SA_amdsmi_nic_rdma_port_info_t
class struct_c__SA_amdsmi_nic_rdma_dev_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_rdma_dev_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_rdma_dev_info_t._fields_ = [
    ...
    ('PADDING_0', ctypes.c_ubyte),
    ('rdma_port_info', struct_c__SA_amdsmi_nic_rdma_port_info_t * 32),
]

amdsmi_nic_rdma_dev_info_t = struct_c__SA_amdsmi_nic_rdma_dev_info_t
class struct_c__SA_amdsmi_nic_rdma_devices_info_t(Structure):
    pass

struct_c__SA_amdsmi_nic_rdma_devices_info_t._pack_ = 1 # source:False
struct_c__SA_amdsmi_nic_rdma_devices_info_t._fields_ = [
    ('num_rdma_dev', ctypes.c_ubyte),
    ('PADDING_0', ctypes.c_ubyte),
    ('rdma_dev_info', struct_c__SA_amdsmi_nic_rdma_dev_info_t * 32),
]

amdsmi_nic_rdma_devices_info_t = struct_c__SA_amdsmi_nic_rdma_devices_info_t
...
amdsmi_get_processor_handles_by_type = _libraries['libamdsmi.so'].amdsmi_get_processor_handles_by_type
...
amdsmi_get_processor_type.argtypes = [amdsmi_processor_handle, ctypes.POINTER(c__EA_amdsmi_processor_type_t)]
...
amdsmi_get_node_handle = _libraries['libamdsmi.so'].amdsmi_get_node_handle
...
amdsmi_get_processor_bdf = _libraries['libamdsmi.so'].amdsmi_get_processor_bdf
amdsmi_get_processor_bdf.restype = amdsmi_status_t
amdsmi_get_processor_bdf.argtypes = [amdsmi_processor_handle, ctypes.POINTER(union_c__UA_amdsmi_bdf_t)]
...
amdsmi_get_nic_processor_handles = _libraries['libamdsmi.so'].amdsmi_get_nic_processor_handles
...
amdsmi_get_nic_device_bdf = _libraries['libamdsmi.so'].amdsmi_get_nic_device_bdf
amdsmi_get_nic_device_bdf.restype = amdsmi_status_t
amdsmi_get_nic_device_bdf.argtypes = [amdsmi_processor_handle, ctypes.POINTER(union_c__UA_amdsmi_bdf_t)]
...
amdsmi_get_gpu_pci_bandwidth = _libraries['libamdsmi.so'].amdsmi_get_gpu_pci_bandwidth
...
amdsmi_get_gpu_accelerator_partition_profile_config_global = _libraries['libamdsmi.so'].amdsmi_get_gpu_accelerator_partition_profile_config_global
amdsmi_get_gpu_accelerator_partition_profile_config_global.restype = amdsmi_status_t
amdsmi_get_gpu_accelerator_partition_profile_config_global.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_accelerator_partition_profile_config_global_t)]
...
amdsmi_topo_get_link_type = _libraries['libamdsmi.so'].amdsmi_topo_get_link_type
amdsmi_topo_get_link_type.restype = amdsmi_status_t
amdsmi_topo_get_link_type.argtypes = [amdsmi_processor_handle, amdsmi_processor_handle, ctypes.POINTER(ctypes.c_uint64), ctypes.POINTER(c__EA_amdsmi_link_type_t)]
...
amdsmi_get_xgmi_plpd = _libraries['libamdsmi.so'].amdsmi_get_xgmi_plpd
amdsmi_get_xgmi_plpd.restype = amdsmi_status_t
amdsmi_get_xgmi_plpd.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_dpm_policy_t)]
amdsmi_set_xgmi_plpd = _libraries['libamdsmi.so'].amdsmi_set_xgmi_plpd
...
amdsmi_get_supported_power_cap = _libraries['libamdsmi.so'].amdsmi_get_supported_power_cap
amdsmi_get_supported_power_cap.restype = amdsmi_status_t
amdsmi_get_supported_power_cap.argtypes = [amdsmi_processor_handle, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(c__EA_amdsmi_power_cap_type_t)]
...
amdsmi_get_afids_from_cper = _libraries['libamdsmi.so'].amdsmi_get_afids_from_cper
...
amdsmi_get_gpu_ras_policy_info = _libraries['libamdsmi.so'].amdsmi_get_gpu_ras_policy_info
amdsmi_get_gpu_ras_policy_info.restype = amdsmi_status_t
amdsmi_get_gpu_ras_policy_info.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_gpu_ras_policy_info_t)]
amdsmi_get_bad_page_threshold = _libraries['libamdsmi.so'].amdsmi_get_bad_page_threshold
...
amdsmi_get_fabric_cper_entries = _libraries['libamdsmi.so'].amdsmi_get_fabric_cper_entries
amdsmi_get_fabric_cper_entries.restype = amdsmi_status_t
amdsmi_get_fabric_cper_entries.argtypes = [amdsmi_processor_handle, uint32_t, ctypes.POINTER(ctypes.c_char), ctypes.POINTER(ctypes.c_uint64), ctypes.POINTER(ctypes.POINTER(struct_c__SA_amdsmi_cper_hdr_t)), ctypes.POINTER(ctypes.c_uint64), ctypes.POINTER(ctypes.c_uint64)]
...
amdsmi_get_vf_hbm_info = _libraries['libamdsmi.so'].amdsmi_get_vf_hbm_info
amdsmi_get_vf_hbm_info.restype = amdsmi_status_t
amdsmi_get_vf_hbm_info.argtypes = [amdsmi_vf_handle_t, ctypes.POINTER(struct_c__SA_amdsmi_vf_hbm_info_t)]
...
amdsmi_get_tdi_state = _libraries['libamdsmi.so'].amdsmi_get_tdi_state
amdsmi_get_tdi_state.restype = amdsmi_status_t
amdsmi_get_tdi_state.argtypes = [amdsmi_vf_handle_t, ctypes.POINTER(c__EA_amdsmi_tdi_state_t)]
amdsmi_get_cc_mode = _libraries['libamdsmi.so'].amdsmi_get_cc_mode
amdsmi_get_cc_mode.restype = amdsmi_status_t
amdsmi_get_cc_mode.argtypes = [amdsmi_processor_handle, ctypes.POINTER(c__EA_amdsmi_cc_mode_t)]
...
amdsmi_get_nic_fw_info = _libraries['libamdsmi.so'].amdsmi_get_nic_fw_info
amdsmi_get_nic_fw_info.restype = amdsmi_status_t
amdsmi_get_nic_fw_info.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_nic_fw_info_t)]
amdsmi_get_nic_asic_info = _libraries['libamdsmi.so'].amdsmi_get_nic_asic_info
amdsmi_get_nic_asic_info.restype = amdsmi_status_t
amdsmi_get_nic_asic_info.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_nic_asic_info_t)]
amdsmi_get_nic_bus_info = _libraries['libamdsmi.so'].amdsmi_get_nic_bus_info
amdsmi_get_nic_bus_info.restype = amdsmi_status_t
amdsmi_get_nic_bus_info.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_nic_bus_info_t)]
amdsmi_get_nic_numa_info = _libraries['libamdsmi.so'].amdsmi_get_nic_numa_info
amdsmi_get_nic_numa_info.restype = amdsmi_status_t
amdsmi_get_nic_numa_info.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_nic_numa_info_t)]
amdsmi_get_nic_port_info = _libraries['libamdsmi.so'].amdsmi_get_nic_port_info
amdsmi_get_nic_port_info.restype = amdsmi_status_t
amdsmi_get_nic_port_info.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_nic_port_info_t)]
amdsmi_get_nic_rdma_dev_info = _libraries['libamdsmi.so'].amdsmi_get_nic_rdma_dev_info
amdsmi_get_nic_rdma_dev_info.restype = amdsmi_status_t
amdsmi_get_nic_rdma_dev_info.argtypes = [amdsmi_processor_handle, ctypes.POINTER(struct_c__SA_amdsmi_nic_rdma_devices_info_t)]
amdsmi_get_nic_port_statistics = _libraries['libamdsmi.so'].amdsmi_get_nic_port_statistics
amdsmi_get_nic_port_statistics.restype = amdsmi_status_t
amdsmi_get_nic_port_statistics.argtypes = [amdsmi_processor_handle, uint32_t, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(struct_c__SA_amdsmi_nic_stat_t)]
amdsmi_get_nic_vendor_statistics = _libraries['libamdsmi.so'].amdsmi_get_nic_vendor_statistics
amdsmi_get_nic_vendor_statistics.restype = amdsmi_status_t
amdsmi_get_nic_vendor_statistics.argtypes = [amdsmi_processor_handle, uint32_t, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(struct_c__SA_amdsmi_nic_stat_t)]
amdsmi_get_nic_rdma_port_statistics = _libraries['libamdsmi.so'].amdsmi_get_nic_rdma_port_statistics
amdsmi_get_nic_rdma_port_statistics.restype = amdsmi_status_t
amdsmi_get_nic_rdma_port_statistics.argtypes = [amdsmi_processor_handle, uint32_t, ctypes.POINTER(ctypes.c_uint32), ctypes.POINTER(struct_c__SA_amdsmi_nic_stat_t)]
__all__ = \
    ...
    'AMDSMI_CARD_FORM_FACTOR_UNKNOWN', 'AMDSMI_CC_MODE_DEV',
    'AMDSMI_CC_MODE_OFF', 'AMDSMI_CC_MODE_ON', 'AMDSMI_CLK_TYPE_DCEF',
    ...
    'AMDSMI_EVENT_THROTTLER_HBM', 'AMDSMI_EVENT_THROTTLER_PROCHOT',
    'AMDSMI_EVENT_THROTTLER_SOCKET', 'AMDSMI_EVENT_THROTTLER_VR',
    ...
    'AMDSMI_FABRIC_TYPE_UNKNOWN', 'AMDSMI_FW_ID_ASD',
    ...
    'AMDSMI_GUEST_FW_ID__MAX', 'AMDSMI_GUEST_FW_LOAD_STATUS_BAD_SIG',
    'AMDSMI_GUEST_FW_LOAD_STATUS_ERR_GENERIC',
    'AMDSMI_GUEST_FW_LOAD_STATUS_FW_LOAD_FAIL',
    'AMDSMI_GUEST_FW_LOAD_STATUS_OBSOLETE_FW',
    'AMDSMI_GUEST_FW_LOAD_STATUS_OK', 'AMDSMI_INIT_ALL_PROCESSORS',
    ...
    'AMDSMI_METRIC_CATEGORY_POWER', 'AMDSMI_METRIC_CATEGORY_STATIC',
    ...
    'AMDSMI_METRIC_NAME_TEMP_AID', 'AMDSMI_METRIC_NAME_TEMP_HBM',
    ...
    'AMDSMI_METRIC_NAME_TEMP_MID', 'AMDSMI_METRIC_NAME_TEMP_SHUTDOWN',
    ...
    'AMDSMI_METRIC_NAME_TEMP_VR_CURR', 'AMDSMI_METRIC_NAME_TEMP_XCD',
    ...
    'AMDSMI_METRIC_RES_GROUP_AID', 'AMDSMI_METRIC_RES_GROUP_GPU',
    'AMDSMI_METRIC_RES_GROUP_MID', 'AMDSMI_METRIC_RES_GROUP_NA',
    'AMDSMI_METRIC_RES_GROUP_SYSTEM',
    'AMDSMI_METRIC_RES_GROUP_UNKNOWN', 'AMDSMI_METRIC_RES_GROUP_XCP',
    'AMDSMI_METRIC_RES_SUBGROUP_BASEBOARD',
    'AMDSMI_METRIC_RES_SUBGROUP_ENGINE',
    'AMDSMI_METRIC_RES_SUBGROUP_GPUBOARD',
    'AMDSMI_METRIC_RES_SUBGROUP_HBM', 'AMDSMI_METRIC_RES_SUBGROUP_NA',
    ...
    'AMDSMI_METRIC_TYPE_INST', 'AMDSMI_METRIC_UNIT_15_625_MILLIJOULE',
    'AMDSMI_METRIC_UNIT_BOOL', 'AMDSMI_METRIC_UNIT_CELSIUS',
    'AMDSMI_METRIC_UNIT_COUNTER', 'AMDSMI_METRIC_UNIT_GBPS',
    'AMDSMI_METRIC_UNIT_JOULE', 'AMDSMI_METRIC_UNIT_MBITPS',
    'AMDSMI_METRIC_UNIT_MHZ', 'AMDSMI_METRIC_UNIT_MILLIVOLT',
    'AMDSMI_METRIC_UNIT_PCIE_GEN', 'AMDSMI_METRIC_UNIT_PCIE_LANES',
    'AMDSMI_METRIC_UNIT_PERCENT', 'AMDSMI_METRIC_UNIT_UINT',
    'AMDSMI_METRIC_UNIT_UNKNOWN', 'AMDSMI_METRIC_UNIT_WATT',
    'AMDSMI_NIC_FW_VERSION_TYPE_FIXED',
    'AMDSMI_NIC_FW_VERSION_TYPE_RUNNING',
    'AMDSMI_NIC_FW_VERSION_TYPE_STORED', 'AMDSMI_NPM_STATUS_DISABLED',
    ...
    'AMDSMI_TDI_STATE_ERROR', 'AMDSMI_TDI_STATE_LOCKED',
    'AMDSMI_TDI_STATE_RUN', 'AMDSMI_TDI_STATE_UNLOCKED',
    ...
    'AMDSMI_VF_CONFIG__MAX', 'AMDSMI_VF_MODE_1', 'AMDSMI_VF_MODE_2',
    'AMDSMI_VF_MODE_4', 'AMDSMI_VF_MODE_8', 'AMDSMI_VF_MODE_ALL',
    'AMDSMI_VF_STATE_ACTIVE', 'AMDSMI_VF_STATE_AVAILABLE',
    'AMDSMI_VF_STATE_DEFAULT_AVAILABLE', 'AMDSMI_VF_STATE_FULLACCESS',
    'AMDSMI_VF_STATE_SUSPENDED', 'AMDSMI_VF_STATE_UNAVAILABLE',
    ...
    'AMDSMI_VIRTUALIZATION_MODE_UNKNOWN', 'AMDSMI_VRAM_TYPE_DDR2',
    ...
    'amdsmi_bdf_t', 'amdsmi_board_info_t',
    ...
    'amdsmi_cper_valid_bits_t', 'amdsmi_dfc_fw_data_t',
    'amdsmi_dfc_fw_header_t', 'amdsmi_dfc_fw_t',
    'amdsmi_dfc_fw_ta_uuid_t', 'amdsmi_dfc_fw_white_list_t',
    'amdsmi_dpm_policy_entry_t', 'amdsmi_dpm_policy_t',
    'amdsmi_driver_info_t', 'amdsmi_driver_model_type_t',
    ...
    'amdsmi_get_bad_page_threshold', 'amdsmi_get_cc_mode',
    'amdsmi_get_clock_info', 'amdsmi_get_cpu_affinity_with_scope',
    'amdsmi_get_dfc_fw_table', 'amdsmi_get_fabric_cper_entries',
    'amdsmi_get_fabric_telemetry_data', 'amdsmi_get_fb_layout',
    ...
    'amdsmi_get_gpu_metrics', 'amdsmi_get_gpu_pci_bandwidth',
    ...
    'amdsmi_get_guest_data', 'amdsmi_get_index_from_processor_handle',
    ...
    'amdsmi_get_npm_info', 'amdsmi_get_num_vf',
    ...
    'amdsmi_nic_asic_info_t', 'amdsmi_nic_bus_info_t',
    'amdsmi_nic_driver_info_t', 'amdsmi_nic_fw_entry_t',
    'amdsmi_nic_fw_info_t', 'amdsmi_nic_fw_t',
    'amdsmi_nic_fw_version_type_t',
    'amdsmi_nic_fw_version_type_t__enumvalues',
    ...
    'amdsmi_npm_status_t', 'amdsmi_npm_status_t__enumvalues',
    'amdsmi_nps_caps_t', 'amdsmi_p2p_capability_t',
    'amdsmi_partition_info_t', 'amdsmi_pcie_bandwidth_t',
    'amdsmi_pcie_info_t', 'amdsmi_pf_fb_info_t',
    'amdsmi_power_cap_info_t', 'amdsmi_power_cap_type_t',
    'amdsmi_power_cap_type_t__enumvalues', 'amdsmi_power_info_t',
    'amdsmi_pp_throttler_type_t',
    'amdsmi_pp_throttler_type_t__enumvalues',
    ...
    'amdsmi_status_t__enumvalues', 'amdsmi_tdi_state_t',
    'amdsmi_tdi_state_t__enumvalues', 'amdsmi_temperature_metric_t',
    ...
    'amdsmi_vf_hbm_info_t', 'amdsmi_vf_info_t', 'amdsmi_vf_mode_t',
    'amdsmi_vf_mode_t__enumvalues', 'amdsmi_vf_sched_state_t',
    'amdsmi_vf_sched_state_t__enumvalues',
    'amdsmi_virtualization_mode_t',
    'amdsmi_virtualization_mode_t__enumvalues', 'amdsmi_vram_info_t',
    'amdsmi_vram_type_t', 'amdsmi_vram_type_t__enumvalues',
    ...
    'c__EA_amdsmi_nic_fw_version_type_t', 'c__EA_amdsmi_npm_status_t',
    'c__EA_amdsmi_power_cap_type_t',
    'c__EA_amdsmi_pp_throttler_type_t',
    'c__EA_amdsmi_processor_type_t',
    'c__EA_amdsmi_profile_capability_type_t',
    'c__EA_amdsmi_ptl_data_format_t', 'c__EA_amdsmi_sched_block_t',
    'c__EA_amdsmi_status_t', 'c__EA_amdsmi_tdi_state_t',
    ...
    'c__EA_amdsmi_virtualization_mode_t', 'c__EA_amdsmi_vram_type_t',
    'c__EA_amdsmi_xgmi_fb_sharing_mode_t', 'int64_t',
    'processor_type_t', 'processor_type_t__enumvalues', 'size_t',
    'struct__links', 'struct_bdf_',
    'struct_c__SA_amdsmi_accelerator_partition_profile_config_global_t',
    'struct_c__SA_amdsmi_accelerator_partition_profile_config_t',
    'struct_c__SA_amdsmi_accelerator_partition_profile_global_t',
    ...
    'struct_c__SA_amdsmi_handshake_t',
    ...
    'struct_c__SA_amdsmi_nic_asic_info_t',
    'struct_c__SA_amdsmi_nic_bus_info_t',
    'struct_c__SA_amdsmi_nic_driver_info_t',
    'struct_c__SA_amdsmi_nic_fw_entry_t',
    'struct_c__SA_amdsmi_nic_fw_info_t',
    'struct_c__SA_amdsmi_nic_fw_t',
    'struct_c__SA_amdsmi_nic_numa_info_t',
    'struct_c__SA_amdsmi_nic_port_info_t',
    'struct_c__SA_amdsmi_nic_port_t',
    'struct_c__SA_amdsmi_nic_rdma_dev_info_t',
    'struct_c__SA_amdsmi_nic_rdma_devices_info_t',
    'struct_c__SA_amdsmi_nic_rdma_port_info_t',
    'struct_c__SA_amdsmi_nic_stat_t',
    'struct_c__SA_amdsmi_npm_info_t',
    ...
    'struct_c__SA_amdsmi_vf_hbm_info_t',
    'struct_c__SA_amdsmi_vf_info_t',
    'struct_c__SA_amdsmi_vram_info_t', 'struct_c__UA_amdsmi_bdf_t_1',
    'struct_cache_', 'struct_cap_', 'struct_fw_info_list_',
    'struct_nps_flags_', 'struct_numa_range_', 'struct_pcie_metric_',
    'struct_pcie_static_', 'struct_ras_info_', 'struct_timespec',
