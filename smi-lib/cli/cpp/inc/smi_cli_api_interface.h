...
public:
	...
	virtual int format_link_status(const int& link_status, bool legend, std::string& out) = 0;
	virtual int transform_ecc_correction_schema(uint32_t flag, std::vector<std::string>& out) = 0;
	virtual int transform_cache_properties(uint32_t initial_property,
										   std::vector<std::string>& properties) = 0;
	virtual int get_string_from_enum_fw_block(int fw_block, std::string& out) = 0;
	virtual int get_string_from_enum_ecc_blocks(int ecc_block, std::string& out) = 0;
	virtual int get_string_from_enum_vf_sched_state(int vf_state, std::string& out) = 0;
	virtual int get_string_from_enum_vf_guard_state(int vf_state, std::string& out) = 0;
	virtual int get_string_from_enum_vf_guard_type(int guard_type, std::string& out) = 0;
	...
	virtual int get_string_from_enum_tdi_state(int tdi_state, std::string& out) = 0;
	virtual int get_string_from_enum_cc_mode(int cc_mode, std::string& out) = 0;
	virtual int get_string_from_enum_nic_topo_link_type(int nic_link_type, std::string& out) = 0;
	virtual int get_string_from_enum_nic_fw_type(int nic_fw_type, std::string& out) = 0;
	...
	virtual int FecModesToString(uint32_t fec, std::string& out) = 0;
	...
	virtual int amdsmi_get_ras_info_command(uint64_t processor_bdf, Arguments arg,
											std::string &out) = 0;
	virtual int amdsmi_get_dfc_info_command(uint64_t processor_bdf, Arguments arg,
											std::string &out) = 0;
	virtual int amdsmi_get_fb_info_command(uint64_t processor_bdf, Arguments arg, std::string &out) = 0;
	virtual int amdsmi_get_num_vf_command(uint64_t processor_bdf, Arguments arg, std::string &out) = 0;
	virtual int amdsmi_get_vram_info_command(uint64_t processor_bdf, Arguments arg,
			std::string &out) = 0;
	virtual int amdsmi_get_cache_info_command(uint64_t processor_bdf, Arguments arg,
			std::string &out) = 0;
	...
	virtual int amdsmi_get_nic_rdma_devices_info_command(uint64_t processor_bdf, Arguments arg,
			std::string& out) = 0;
	virtual int amdsmi_get_nic_fw_info_command(uint64_t processor_bdf, Arguments arg,
			std::string& out) = 0;
	...
	virtual int amdsmi_firmware_fw_list_command(uint64_t processor_bdf, Arguments arg,
			std::string &out, std::string *gpu_id) = 0;
	...
	virtual int amdsmi_firmware_vf_fw_list_command(std::string device, Arguments arg,
			std::string *gpu_id, std::string *vf_id, std::string &out) = 0;
	...
	virtual int amdsmi_get_pcie_metric_command(uint64_t processor_bdf, Arguments arg,
			std::string& out) = 0;
	virtual int amdsmi_get_xgmi_metric_command(Arguments arg, std::string& out) = 0;
	...
	virtual int amdsmi_get_all_arguments_process_command(uint64_t processor, Arguments arg,
			std::string &out_string, int &proc_num, int gpu_id) = 0;
	...
	virtual int amdsmi_get_engine_process_command(uint64_t processor, Arguments arg,
			std::string &out_string, int &proc_num, int gpu_id) = 0;
	virtual int amdsmi_get_version_command(uint64_t processor_bdf, Arguments arg, std::string &out_string) = 0;
	...
	virtual int amdsmi_get_pcie_info_monitor_command(uint64_t processor_bdf, Arguments arg,
			std::string &formatted_string) = 0;
	virtual int amdsmi_get_process_monitor_command(Arguments arg, std::string &formatted_string) = 0;
	virtual int amdsmi_set_memory_partition_command(uint64_t processor_bdf, Arguments arg) = 0;
	virtual int amdsmi_set_accelerator_partition_command(uint64_t processor_bdf, Arguments arg) = 0;
	...
	// Fabric
	virtual int amdsmi_get_fabric_topology_command(uint64_t processor_bdf, Arguments arg, std::string& out) = 0;
	...
	virtual int amdsmi_get_cc_mode_command(uint64_t processor_bdf, Arguments arg,
			std::string &formatted_string) = 0;
	virtual int amdsmi_set_cc_mode_command(uint64_t processor_bdf, Arguments arg) = 0;

	// Fabric
	virtual int amdsmi_get_fabric_telemetry_command(uint64_t processor_bdf, Arguments arg, std::string& out) = 0;
